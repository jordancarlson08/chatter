...
import com.chatbooks.chatter.internal.support.FormatUtils;
...
public class TransactionActivity extends BaseChatterActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.chatter_activity_transaction);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.chatter_transaction, menu);
    ...
    class PagerAdapter extends FragmentStatePagerAdapter {
        ...
        private final int[] TITLE_RES_IDS = {
                R.string.chatter_overview,
                R.string.chatter_request,
                R.string.chatter_response
        };
