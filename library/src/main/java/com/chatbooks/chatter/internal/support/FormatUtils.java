...
import com.chatbooks.chatter.internal.data.entity.HttpHeader;
...
public class FormatUtils {
    ...
    public static String getShareText(Context context, HttpTransaction transaction) {
        String text = "";
        text += context.getString(R.string.chatter_url) + ": " + v(transaction.getUrl()) + "\n";
        text += context.getString(R.string.chatter_method) + ": " + v(transaction.getMethod()) + "\n";
        text += context.getString(R.string.chatter_protocol) + ": " + v(transaction.getProtocol()) + "\n";
        text += context.getString(R.string.chatter_status) + ": " + v(transaction.getStatus().toString()) + "\n";
        text += context.getString(R.string.chatter_response) + ": " + v(transaction.getResponseSummaryText()) + "\n";
        text += context.getString(R.string.chatter_ssl) + ": " + v(context.getString(transaction.isSsl() ? R.string.chatter_yes : R.string.chatter_no)) + "\n";
        text += "\n";
        text += context.getString(R.string.chatter_request_time) + ": " + v(transaction.getRequestDateString()) + "\n";
        text += context.getString(R.string.chatter_response_time) + ": " + v(transaction.getResponseDateString()) + "\n";
        text += context.getString(R.string.chatter_duration) + ": " + v(transaction.getDurationString()) + "\n";
        text += "\n";
        text += context.getString(R.string.chatter_request_size) + ": " + v(transaction.getRequestSizeString()) + "\n";
        text += context.getString(R.string.chatter_response_size) + ": " + v(transaction.getResponseSizeString()) + "\n";
        text += context.getString(R.string.chatter_total_size) + ": " + v(transaction.getTotalSizeString()) + "\n";
        text += "\n";
        text += "---------- " + context.getString(R.string.chatter_request) + " ----------\n\n";
        ...
        text += (transaction.isRequestBodyPlainText()) ? v(transaction.getFormattedRequestBody()) :
                context.getString(R.string.chatter_body_omitted);
        text += "\n\n";
        text += "---------- " + context.getString(R.string.chatter_response) + " ----------\n\n";
