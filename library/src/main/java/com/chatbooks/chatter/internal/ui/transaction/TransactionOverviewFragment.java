...
public class TransactionOverviewFragment extends Fragment implements TransactionFragment {
    ...
    public View onCreateView(@NotNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.chatter_fragment_transaction_overview, container, false);
    ...
    private void populateUI() {
        if (isAdded() && transaction != null) {
            ...
            ssl.setText((transaction.isSsl() ? R.string.chatter_yes : R.string.chatter_no));
