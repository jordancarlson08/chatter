...
public class TransactionAdapter extends RecyclerView.Adapter<TransactionAdapter.ViewHolder> {
    ...
    TransactionAdapter(Context context, TransactionClickListListener listener) {
        ...
        colorDefault = ContextCompat.getColor(context, R.color.chatter_status_default);
        colorRequested = ContextCompat.getColor(context, R.color.chatter_status_requested);
        colorError = ContextCompat.getColor(context, R.color.chatter_status_error);
        color500 = ContextCompat.getColor(context, R.color.chatter_status_500);
        color400 = ContextCompat.getColor(context, R.color.chatter_status_400);
        color300 = ContextCompat.getColor(context, R.color.chatter_status_300);
    }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.chatter_list_item_transaction, parent, false);
    ...
    class ViewHolder extends RecyclerView.ViewHolder {
        ...
        ViewHolder(View view) {
            super(view);
            this.view = view;
            code = view.findViewById(R.id.chatter_code);
            path = view.findViewById(R.id.chatter_path);
            host = view.findViewById(R.id.chatter_host);
            start = view.findViewById(R.id.chatter_time_start);
            duration = view.findViewById(R.id.chatter_duration);
            size = view.findViewById(R.id.chatter_size);
            ssl = view.findViewById(R.id.chatter_ssl);
        }
